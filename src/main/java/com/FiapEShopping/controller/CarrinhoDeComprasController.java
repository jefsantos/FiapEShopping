...
public class CarrinhoDeComprasController {
    ...
    @PostMapping("/adicionarItem/{carrinhoId}")
    public void adicionarItens(@PathVariable UUID carrinhoId, @RequestBody ItemDTO itemDTO) {
        carrinhoDeComprasService.adicionarItens(carrinhoId, itemDTO);
    }

    @DeleteMapping("/{carrinhoId}/removerItem/{itemId}")
    public void removerItem(@PathVariable UUID carrinhoId, @PathVariable UUID itemId) {
        carrinhoDeComprasService.removerItens(carrinhoId, itemId);
    }
}
